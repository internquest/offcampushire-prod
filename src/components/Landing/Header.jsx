...
export default function Header({ loading }) {
  ...
  return (
    ...
    <motion.div layoutId="hero" transition={{ duration: .3, ease: 'easeIn' }} className=" bg-[url('https://ik.imagekit.io/0ytuu3ujr/mob%20home-min.jpg')]  md:bg-[url('https://ik.imagekit.io/0ytuu3ujr/tab%20home-min.jpg')]  lg:bg-[url('https://ik.imagekit.io/0ytuu3ujr/2d-graphic-colorful-wallpaper-with-grainy-gradients-min.jpg')]  h-[626px] w-full md:h-[996px]  lg:min-h-[813px] lg:max-h-[1100px]   bg-center bg-no-repeat bg-cover  bmt:h-screen    flex-col px-2 py-12 md:px-3 md:py-14 lg:px-28 lg:py-32  ">
      {!loading && (
