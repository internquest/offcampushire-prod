...
export default function Header({ loading }) {
  ...
  return (
    <>
      {
        !loading && (
          <motion.div layoutId="hero" transition={{ duration: 1, ease: [0.6, 0.01, -0.05, 0.9] }} className=" bg-[url('https://ik.imagekit.io/0ytuu3ujr/mob%20home-min.jpg')]  md:bg-[url('https://ik.imagekit.io/0ytuu3ujr/tab%20home-min.jpg')]  lg:bg-[url('https://ik.imagekit.io/0ytuu3ujr/2d-graphic-colorful-wallpaper-with-grainy-gradients-min.jpg')]  h-[626px] w-full lg:h-[1200px]  lg:min-h-[813px] lg:max-h-[1100px]   bg-center bg-no-repeat bg-cover  bmt:h-screen    flex-col px-2 py-12  md:py-14  lg:py-28  ">

            <motion.h1 layoutId='text' className={` mx-auto font-semibold  text-start  text-[34px] md:text-[50px] 2xl:text-[4.5rem]    px-0  bmt:leading-[1.75] leading-[1.6] tracking-normal w-full  md:max-w-[593px] 2xl:max-w-[950px]        ${MonaMedium.className}`}><WordsInview isclip={true}>The future of off-campus</WordsInview><WordsInview isclip={true}>placement drives is here</WordsInview></motion.h1>

            <motion.button whileHover='hover' variants={buttonVariants} className={`mx-auto block px-2   ${GeneralMedium.className} rounded-[5px] font-bold tracking-wide leading-7 text-2xl bg-gradient-to-r from-[#6161A6] to-[#252540] mt-4 text`}>
              <motion.span variants={textVariant} className={`${MonaSemibold.className} bg-clip-text h-[36px] w-[110px] [-webkit-background-clip:text] inline-block whitespace-nowrap border-none outline-none bg-gradient-to-br px-2 py-1 from-[#FFFFFF] to-[#F2F4FE] text-[1rem]  font-medium text-transparent`}>
                Get Started
              </motion.span>
            </motion.button>

            <Image src='https://ik.imagekit.io/0ytuu3ujr/Group%2062.svg' alt="" width={1000} height={798} className="mx-auto mt-20" />
