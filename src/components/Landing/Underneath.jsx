        ...
        <>
            <div data-scroll data-scroll-section className={`bg-white rounded-[50px]    lg:-mt-[600px] relative`}>
                ...
                <div className="mx-auto duration-0  bg-cover  bg-top  flex flex-col gap-3 items-center justify-start w-full xl:w-[1280px]  md:h-[572px] mt-14 pt-10 px-3 mb-16 md:mb-96">
                    ...
                    <h2 className={`${GeneralMedium.className} font-medium text-[24px] bmt:min-w-fit md:w-[489px] text-[#020617BF]/[.75] tracking-[.01em] text-start md:text-center leading-[1.8] `}>We're changing the way students explore the realm of offcampus placement opportunities</h2>
                    ...
                    <div className="  w-full  md:w-[575px] border-solid border-[5px] mt-4 md:mt-12 border-[#E2E8F0] rounded-[20px]  md:h-[525px] px-6 bg-white   pt-14 pb-14 ">
                        <h1 className={` mx-5 ${MonaMedium.className} font-medium text-[20px] md:text-[36px] leading-[2] text-[#462B34] tracking-[-.0095em] lg:w-[440px] text-start pb-8`}>Our goal is to<span className="bg-gradient-to-r from-[#0066FF] to-[#003D99] [-webkit-background-clip:text] bg-clip-text text-transparent px-2">upgrade,<br />reimagine, and revolutionize</span>the off-
                            campus placements
                            scenario in India</h1>
                    </div>

                    <p className={`${GeneralMedium.className} font-medium text-[24px] mt-8 w-full md:w-[680px] tracking-[0.005em]  text-start md:text-center leading-[2]  text-[#6161A6]`}>The traditional off-campus placements ecosystem in India <br /> is broken. It's time for a change,and we're leading the charge</p>
                </div>
                {/* </motion.section > */}
            </div>
