        ...
        <section className=" pt-0 bg-gradient-to-b from-[#020617] to-[#0B217D] mt-14 pb-[120px] rounded-br-[65px] lg:mt-14 lg:pt-14 rounded-bl-[65px]">
            ...
            <div className='max-w-[1438px] w-[92%] mx-auto'>
                <div className='md:w-[65.6787658876%] relative tablet:pb-[160px] bmMt:pb-[120px]'>
                    ...
                    <div className=' bmt:w-[150px] bmt:h-[90px] tablet:w-[200px] tablet:left-[50%] text-white tablet:bottom-0 tablet:translate-x-[-50%] md:h-[130px] md:w-[34.1834874345%] md:left-[118.47873428734%] lg:top-0  lg:w-[21.0134532632635%] lg:left-[131.63534953495%] lg:h-[130px] absolute flex flex-col justify-center pointer-events-none items-center gap-[10px] [counter-reset:num] [&>*]:[counter-increment:num]  [&>*]:before:[content:counter(num)]   [&>*]:before:text-[0.875rem]  [&>*]:before:block '>
