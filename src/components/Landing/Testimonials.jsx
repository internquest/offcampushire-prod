...
import { MonaCondensedBold, MonaCondensedEBold } from '@/utils/fonts'
...
const Testimonials = () => {
    ...
    return (
        <section className=" pt-0 bg-gradient-to-b from-[#020617] to-[#0B217D] mt-14 pb-[120px]  lg:mt-14 lg:pt-24  rounded-[40px]">
            <div className="mb-10  max-w-[1438px] w-[92%] mx-auto px-12">
                <div className="md:w-[65.6787658876%]  pt-14">
                    <h4 className={` text-[6vw] sm:text-[2.125rem] lg:text-[2.625rem]  bL4k:text-[3.5rem]  font-bold text-white tracking-wide uppercase leading-[2.3] ${MonaCondensedBold.className} `}>WHAT students have to say </h4>
                </div>
            </div>
            <div className='max-w-[1438px] w-[92%]  mx-auto px-12'>
                <div className='md:w-[65.6787658876%] relative tablet:pb-[160px] bmMt:pb-[120px]'>
                    ...
                    <div className=' bmt:w-[150px] bmt:h-[90px] tablet:w-[200px] tablet:bottom-0 md:h-[130px] left-[50%] translate-x-[-50%]   md:w-[34.1834874345%] md:left-[118.47873428734%] md:translate-x-0 md:top-0 lg:w-[21.0134532632635%]  absolute flex justify-between items-center gap-[10px]'>
                    ...
                    <div className=' bmt:w-[150px] bmt:h-[90px] tablet:w-[200px] tablet:left-[50%] text-white tablet:bottom-0 tablet:translate-x-[-50%] md:h-[130px] md:w-[34.1834874345%] md:left-[118.47873428734%] md:top-0  lg:w-[21.0134532632635%]  lg:h-[130px] absolute flex flex-col justify-center pointer-events-none items-center gap-[10px] [counter-reset:num] [&>*]:[counter-increment:num]  [&>*]:before:[content:counter(num)]   [&>*]:before:text-[0.875rem]  [&>*]:before:block '>
