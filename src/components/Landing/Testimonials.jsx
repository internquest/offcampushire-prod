...
const Testimonials = () => {
    ...
    return (
        <section className=" pt-0 bg-white mt-8 pb-[220px] rounded-br-[65px] mt-14 pt-20 rounded-bl-[65px]">
            {/* <div className="mb-12 max-w-[1438px] w-[92%] mx-auto">
                <div className="md:w-[65.6787658876%] mt-11 pt-14">
                    <h4 className=" text-[7vw] sm:text-[2.125rem] lg:text-[2.625rem]  bL4k::text-[3.25rem] mt-3 font-extrabold text-[#030326] uppercase leading-[68%] ">WHAT THEY SAY</h4>
                </div>
            </div> */}
            <div className='max-w-[1438px] w-[92%] mx-auto'>
                <div className='md:w-[65.6787658876%] relative tablet:pb-[160px] bmMt:pb-[120px]'>
                    ...
                    <div className=' bmt:w-[150px] bmt:h-[90px] tablet:w-[200px] tablet:bottom-0 md:h-[130px] left-[50%] translate-x-[-50%]   md:w-[34.1834874345%] md:left-[118.47873428734%] lg:translate-x-0 lg:top-0 lg:w-[21.0134532632635%] lg:left-[131.63534953495%] absolute flex justify-between items-center gap-[10px]'>
                    ...
                    <div className=' bmt:w-[150px] bmt:h-[90px] tablet:w-[200px] tablet:left-[50%] tablet:bottom-0 tablet:translate-x-[-50%] md:h-[130px] md:w-[34.1834874345%] md:left-[118.47873428734%] lg:top-0  lg:w-[21.0134532632635%] lg:left-[131.63534953495%] lg:h-[130px] absolute flex flex-col justify-center pointer-events-none items-center gap-[10px] [counter-reset:num] [&>*]:[counter-increment:num]  [&>*]:before:[content:counter(num)]   [&>*]:before:text-[0.875rem]  [&>*]:before:block '>
