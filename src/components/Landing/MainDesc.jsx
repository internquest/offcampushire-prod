...
const MainDesc = ({ marqref, descRef }) => {
  ...
  return (
    <motion.section ref={descRef} style={{ y: marqrefinview && -1.8 * transfromY }} className='relative w-sc bg-white  rounded-[50px] '>
      {/* <motion.section data-scroll data-scroll-speed='1.6' data-scroll-offset='-1800,1800' data-scroll-class='isInview' className='relative opacity-0 w-sc bg-white   rounded-[50px]  '> */}
