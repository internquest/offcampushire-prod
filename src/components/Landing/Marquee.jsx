...
const Marquee = ({ marqref }) => {
    ...
    return (
        ...
        <motion.section ref={marqref} style={{ y: -transfromY * .3 }} className={`text-white translate-y-0 pb-6  relative bg-gradient-to-r from-[#6161A6] to-[#252540] -mt-10 rounded-[50px] `}>
