...
const Marquee = ({ marqref }) => {
    ...
    return (
        <section data-scroll data-scroll-speed='.1' data-scroll-offset='-100%,100%' data-scroll-class='isInview' className={`text-white opacity-0 translate-y-0 pb-6  relative bg-gradient-to-r from-[#6161A6] to-[#252540]  `}>
