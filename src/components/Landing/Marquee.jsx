...
const Marquee = ({ marqref }) => {
    ...
    return (
        ...
        <>
            <motion.section ref={marqref} style={{ y: -transfromY * .5 }} className={`text-white hidden lg:block translate-y-0 pb-6  relative bg-gradient-to-r bm4k:-mt-10 from-[#6161A6] to-[#252540] rounded-[50px] `}>
