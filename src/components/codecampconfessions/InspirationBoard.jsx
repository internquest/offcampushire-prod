...
const InspirationBoard = () => {
    return (
        <div className='mt-4 max-w-[1280px] flex px-4 flex-col gap-5 '>
            <div className='flex   gap-4 justify-center '>
                <div className='w-[707px] flex flex-col gap-4 items-center font-saanstrialMedium bg-[#E6E8FE] px-4 py-6 text-[#2c2c2c]'>
                    ...
                    <div className='flex gap-5 self-start mt-3 ml-8 text-[#2C2C2C]/[0.5]  '>
                        <p className='text-2xl font-black leading-7 tracking-wide'>PAYTM</p>
                        <p className='text-2xl font-black leading-7 tracking-wide'>PHONEPE</p>
                        <p className='text-2xl font-black leading-7 tracking-wide'>RAZORPAY</p>
                        <p className='text-2xl font-black leading-7 tracking-wide  text-[#2C2C2C]/[0.6] '>CRED</p>
                    </div>
                ...
                <div className='w-[530px]  flex flex-col items-center justify-between font-saanstrialMedium rounded-[10px] border-[5px] border-[#4A5FF7] px-7 pb-5 opacity-60 self-stretch '>
                    <div>
            ...
            <div className='bg-[#3B3B3A] flex flex-col rounded-[10px] '>
                <div className='flex gap-4'>
                    <div className='flex flex-col font-saanstrialMedium  text-[#DDFC9D] ml-8 gap-8'>
                        ...
                        <p className='w-[338px] font-medium text-2xl tracking-[0.02em] leading-[2.75rem]'>AI Fake News Detector to test
                    ...
                    <div className='flex flex-col justify-between'>
                        <div className='w-[794px] mt-8 px-7 py-12 border-2 border-[#FFFFFF] rounded-[10px] border-opacity-60'>
                        ...
                        <p className='font-saanstrialBold self-end text-5xl leading-[1.2] -mb-3 text-[#ffffff]/[0.6] '>Expected Outcomes</p>
                    </div>
                </div>

                <div className='ml-6  mr-16 mt-8 flex pl-7 py-7 gap-5  rounded-[5px] bg-[#FFFFFF]'>
                    <div className='flex flex-col w-[350px] items-start gap-11 pl-7 py-8 pr-12 bg-[#ECEDEA] rounded-[10px]'>
                        <p className='font-saanstrialMedium text-2xl font-semibold leading-[1.25] tracking-wide text-[#2C2C2C]'>Comprehensive Dataset</p>
                        <p className='text-[#2C2C2CB2]/[.7] font-saanstrialMedium font-medium  -tracking-wide  text-[22px] leading-[2] '>A well-curated and labeled
                    ...
                    <div className='flex flex-col w-[350px] items-start gap-11 pl-7 py-8 pr-12 bg-[#ECEDEA] rounded-[10px]'>
                        ...
                        <p className='text-[#2C2C2CB2]/[.7] font-saanstrialMedium font-medium  -tracking-wide   text-[22px] leading-[2] '>An AI model capable of
                    ...
                    <div className='flex flex-col  w-[365px] items-start gap-11 pl-7 py-8 pr-12 bg-[#ECEDEA] rounded-[10px]'>
                        <p className='font-saanstrialMedium text-2xl font-semibold leading-[1.25] tracking-wide text-[#2C2C2C]'>Insightful Analysis</p>
                        <p className='text-[#2C2C2CB2]/[.7] font-saanstrialMedium font-medium -tracking-wide    text-[22px] leading-[2] '>A detailed analysis of the model's
                ...
                <div className='font-saanstrialMedium font-medium text-4xl leading-10 flex self-end  mr-16 mt-4 tracking-wide text-white/[.8]'>#machine-learning</div>
                <div className='font-saanstrialMedium font-medium text-4xl leading-10 flex self-end  mr-16 mt-8 mb-14 tracking-wide text-white/[.8]'>#artificial-intelligence</div>
            </div>

            <div className='min-h-5 w-full gap-8 mb-8 flex'>
                <div className='bg-[#8524FF] flex flex-col gap-12 w-[720px] px-4 pl-5 rounded-[10px] pt-1'>
                ...
                <div className='w-[498px] rounded-[10px] flex flex-col p-6 bg-[#FAD49B]'>
