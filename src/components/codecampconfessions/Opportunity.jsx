...
const Opportunity = () => {
    return (
        <div className={`w-screen    flex  flex-col gap-[2rem] justify-center pt-[10rem] pb-[8rem] mt-[2rem] items-center  opportunitybg  bg-cover bg-no-repeat  bg-bottom font-generalSans `}>
            <div className='w-[655px]   font-medium text-[23px] mb-[1rem] leading-[3rem] text-[#ffffff] '> We're calling all students who've faced broken promises,
            ...
            <div className='bg-[#ffffff]  w-[684px] rounded-[10px]  p-[1rem] px-[2rem] pb-[1.5rem]'>
