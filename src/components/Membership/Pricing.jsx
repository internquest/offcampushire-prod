...
const Pricing = () => {
    return (
        <div className="px-4 py-8 md:py-16 flex flex-col w-full items-center justify-center">
            ...
            <div className="flex flex-col w-full items-center justify-center  gap-y-8 md:gap-y-16 py-8 md:py-16">
                <EachPricingCard />
                {/* <EachPricingCard /> */}
                <Secondcard />
            </div>
