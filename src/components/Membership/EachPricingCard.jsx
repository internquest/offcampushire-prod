...
const EachPricingCard = () => {
    return (
        <div className="flex flex-col lg:flex-row relative w-full  justify-center ">
            ...
            <div className={` mem1card w-full lg:max-w-[450px] xl:max-w-[676px] min-h-[411px] pr-2 lg:-mr-28 text-white   flex justify-center items-center flex-col relative flex-grow rounded-[20px] ${GeneralMedium.className}`}>
